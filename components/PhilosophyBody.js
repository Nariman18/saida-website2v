...
function PhilosophyBody() {
  return (
    ...
    <img src='/Rectangle 6.png' alt='Banner' className='2xl:absolute xl:absolute relative 2xl:w-[853px] xl:w-[853px] lg:w-[760px] md:w-[653px] sm:w-[653px] w-[310px] 2xl:h-[657px] xl:h-[657px] lg:h-[657px] md:h-[550px] h-[300px] 2xl:left-[666px] xl:left-[666px] 2xl:top-[-400px] xl:top-[-400px] object-contain'/>  
            ...
            <p className='text-[#848484] text-left w-[310px] text-[16px] font-Catamaran font-[200]'>I love art only if it has a meaning I love art only if it has a meaning I love art only if it has a meaning I love art only if it has a meaning I love art only if it has a meaning I love art only if it has a meaning</p>
            <p className='text-[#848484] text-left w-[310px] text-[16px] font-Catamaran font-[200]'>I love art only if it has a meaning I love art only if it has a meaning I love art only if it has a meaning</p>
            <h4 className='text-[#848484] text-left w-[310px] text-[16px] font-Catamaran font-[200] underline underline-offset-[3px] decoration-1 decoration-gray-300'>Meaning</h4>
            </div>  
